...
if [ -f "$TEMPLATE_SRC" ]; then
  ...
  CODE_REVIEW=${CODE_REVIEW_URL:-${VITE_CODE_REVIEW_URL:-__CODE_REVIEW_URL__}}
  ...
  sed \
    ...
    -e "s|__CODE_REVIEW_URL__|$CODE_REVIEW|g" \
...
USED_KEYS="API_BASE_URL AI_AGENTIC_URL CODE_CONVERSION_URL DOCUMENT_INSIGHTS_URL CODE_INSIGHTS_URL CODE_REVIEW_URL VITE_API_BASE_URL VITE_AI_AGENTIC_URL VITE_CODE_CONVERSION_URL VITE_DOC_INSIGHTS_URL VITE_DOCUMENT_INSIGHTS_URL VITE_CODE_INSIGHTS_URL VITE_CODE_REVIEW_URL"
