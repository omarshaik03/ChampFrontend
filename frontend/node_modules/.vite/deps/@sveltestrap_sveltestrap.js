...
function UncontrolledAlert($$anchor, $$props) {
  ...
  var $$exports = { ...legacy_api() };
  add_svelte_meta(
    () => Alert($$anchor, spread_props(() => $$restProps, {
      dismissible: true,
...
function ButtonDropdown($$anchor, $$props) {
  ...
  var $$exports = { ...legacy_api() };
  add_svelte_meta(
    () => Dropdown($$anchor, spread_props(() => $$restProps, {
      group: true,
      $$events: {
        click($$arg) {
          bubble_event.call(this, $$props, $$arg);
  ...
  add_svelte_meta(
    () => each(div, 5, items, index, ($$anchor2, item, index2) => {
      ...
      template_effect(() => {
        ...
        classes_1 = set_class(button, 1, "", null, classes_1, { active: strict_equals(activeIndex(), index2) });
...
function CarouselItem($$anchor, $$props) {
  ...
  attribute_effect(div, () => ({
    ...$$restProps,
    class: get(classes),
    [CLASS]: { active: strict_equals(itemIndex(), activeIndex()) }
  }));
  var node = child(div);
  slot(node, $$props, "default", {}, null);
  reset(div);
...
var root_26 = add_locations(from_html(`<th><!> <!></th>`), Column[FILENAME], [[18, 2]]);
var root_43 = add_locations(from_html(`<th><!> <!></th>`), Column[FILENAME], [[23, 2]]);
var root_6 = add_locations(from_html(`<td><!></td>`), Column[FILENAME], [[28, 2]]);
  ...
  var node = first_child(fragment);
  {
    ...
    add_svelte_meta(
      () => if_block(node, ($$render) => {
        ...
        else if (foot) $$render(consequent_2, 1);
        else if (head2) $$render(consequent_4, 2);
        else $$render(alternate, false);
      }),
      "if",
      Column,
...
var root_27 = add_locations(from_html(`<div><!></div>`), DropdownItem[FILENAME], [[44, 4]]);
var root_32 = add_locations(from_html(`<a><!></a>`), DropdownItem[FILENAME], [[48, 4]]);
var root_44 = add_locations(from_html(`<button><!></button>`), DropdownItem[FILENAME], [[52, 4]]);
  ...
  var node = child(li);
  {
    ...
    add_svelte_meta(
      () => if_block(node, ($$render) => {
        ...
        else if (divider()) $$render(consequent_1, 1);
        else if (href()) $$render(consequent_2, 2);
        else $$render(alternate, false);
      }),
      "if",
      DropdownItem,
...
var root_28 = add_locations(from_html(`<span class="visually-hidden"> </span>`), DropdownToggle[FILENAME], [[64, 6]]);
var root_112 = add_locations(from_html(`<a><!></a>`), DropdownToggle[FILENAME], [[53, 2]]);
var root_45 = add_locations(from_html(`<span class="visually-hidden"> </span>`), DropdownToggle[FILENAME], [[79, 6]]);
var root_33 = add_locations(from_html(`<div><!></div>`), DropdownToggle[FILENAME], [[69, 2]]);
var root_62 = add_locations(from_html(`<span class="visually-hidden"> </span>`), DropdownToggle[FILENAME], [[94, 6]]);
var root_52 = add_locations(from_html(`<span><!></span>`), DropdownToggle[FILENAME], [[84, 2]]);
var root_82 = add_locations(from_html(`<span class="visually-hidden"> </span>`), DropdownToggle[FILENAME], [[109, 6]]);
var root_7 = add_locations(from_html(`<button><!></button>`), DropdownToggle[FILENAME], [[98, 2]]);
function DropdownToggle($$anchor, $$props) {
  ...
  var node = first_child(fragment);
  {
    ...
    add_svelte_meta(
      () => if_block(node, ($$render) => {
        if (nav()) $$render(consequent);
        else if (strict_equals(tag(), "div")) $$render(consequent_1, 1);
        else if (strict_equals(tag(), "span")) $$render(consequent_2, 2);
        else $$render(alternate, false);
      }),
      "if",
      DropdownToggle,
...
var root_29 = add_locations(from_html(`<input/>`), FormCheck[FILENAME], [[53, 4]]);
var root_34 = add_locations(from_html(`<input/>`), FormCheck[FILENAME], [[69, 4]]);
var root_46 = add_locations(from_html(`<label class="form-check-label"><!></label>`), FormCheck[FILENAME], [[86, 4]]);
...
function FormCheck($$anchor, $$props) {
  ...
  var node = child(div);
  {
    ...
    add_svelte_meta(
      () => if_block(node, ($$render) => {
        ...
        else if (strict_equals(type(), "switch")) $$render(consequent_1, 1);
        else $$render(alternate, false);
      }),
      "if",
      FormCheck,
  ...
  var node_1 = sibling(node, 2);
  {
    var consequent_2 = ($$anchor2) => {
      ...
      slot(node_2, $$props, "label", {}, ($$anchor3) => {
        var text2 = text();
...
var root_210 = add_locations(from_html(`<label> <!></label>`), FormGroup[FILENAME], [[73, 6]]);
var root_116 = add_locations(from_html(`<fieldset><!> <!></fieldset>`), FormGroup[FILENAME], [[69, 2]]);
var root_47 = add_locations(from_html(`<label> <!></label>`), FormGroup[FILENAME], [[84, 6]]);
...
var root_211 = add_locations(from_html(`<input/>`), Input[FILENAME], [[244, 4]]);
var root_36 = add_locations(from_html(`<input/>`), Input[FILENAME], [[269, 4]]);
var root_48 = add_locations(from_html(`<input/>`), Input[FILENAME], [[293, 4]]);
var root_53 = add_locations(from_html(`<input/>`), Input[FILENAME], [[319, 4]]);
var root_72 = add_locations(from_html(`<input/>`), Input[FILENAME], [[375, 4]]);
var root_83 = add_locations(from_html(`<input/>`), Input[FILENAME], [[401, 4]]);
var root_9 = add_locations(from_html(`<input/>`), Input[FILENAME], [[427, 4]]);
var root_10 = add_locations(from_html(`<input/>`), Input[FILENAME], [[453, 4]]);
var root_11 = add_locations(from_html(`<textarea></textarea>`), Input[FILENAME], [[478, 2]]);
var select_content = add_locations(from_html(`<!>`, 1), Input[FILENAME], []);
var root_122 = add_locations(from_html(`<select><!></select>`), Input[FILENAME], [[501, 2]]);
...
function Input($$anchor, $$props) {
  ...
  let max2 = prop($$props, "max", 8, void 0);
  let min2 = prop($$props, "min", 8, void 0);
  ...
  var node = first_child(fragment);
  {
    var consequent_8 = ($$anchor2) => {
      ...
      var node_1 = first_child(fragment_1);
      {
        ...
        var consequent_4 = ($$anchor3) => {
          {
            $$ownership_validator.binding("checked", FormCheck, checked);
            $$ownership_validator.binding("inner", FormCheck, inner);
            $$ownership_validator.binding("group", FormCheck, group);
            $$ownership_validator.binding("value", FormCheck, value);
            add_svelte_meta(
              () => FormCheck($$anchor3, spread_props(() => $$restProps, {
                get "data-bs-theme"() {
                  return theme();
                },
                get class() {
        ...
        add_svelte_meta(
          () => if_block(node_1, ($$render) => {
            ...
            else if (strict_equals(type(), "color")) $$render(consequent_1, 1);
            else if (strict_equals(type(), "email")) $$render(consequent_2, 2);
            else if (strict_equals(type(), "file")) $$render(consequent_3, 3);
            else if (strict_equals(type(), "checkbox") || strict_equals(type(), "radio") || strict_equals(type(), "switch")) $$render(consequent_4, 4);
            else if (strict_equals(type(), "number")) $$render(consequent_5, 5);
            else if (strict_equals(type(), "range")) $$render(consequent_6, 6);
            else if (strict_equals(type(), "date") || strict_equals(type(), "datetime") || strict_equals(type(), "datetime-local") || strict_equals(type(), "month") || strict_equals(type(), "time") || strict_equals(type(), "week")) $$render(consequent_7, 7);
            else $$render(alternate, false);
          }),
          "if",
          Input,
    ...
    add_svelte_meta(
      () => if_block(node, ($$render) => {
        ...
        else if (strict_equals(get(tag), "textarea")) $$render(consequent_9, 1);
        else if (strict_equals(get(tag), "select") && !multiple()) $$render(consequent_10, 2);
      }),
      "if",
      Input,
      242,
    ...
    var consequent_12 = ($$anchor2) => {
      ...
      var node_4 = first_child(fragment_4);
      {
        var consequent_11 = ($$anchor3) => {
          ...
          var node_5 = first_child(fragment_5);
          add_svelte_meta(
            () => each(node_5, 1, feedback, index, ($$anchor4, msg) => {
              add_svelte_meta(
                () => FormFeedback($$anchor4, {
                  get valid() {
                    return valid();
                  },
        ...
        var d = user_derived(() => (deep_read_state(feedback()), untrack(() => Array.isArray(feedback()))));
        var alternate_1 = ($$anchor3) => {
          add_svelte_meta(
            () => FormFeedback($$anchor3, {
              get valid() {
                return valid();
              },
...
var root_212 = add_locations(from_html(`<ul><!></ul>`), ListGroup[FILENAME], [[49, 2]]);
...
var root_213 = add_locations(from_html(`<button><!></button>`), ListGroupItem[FILENAME], [[26, 2]]);
var root_37 = add_locations(from_html(`<li><!></li>`), ListGroupItem[FILENAME], [[32, 2]]);
  ...
  var node = first_child(fragment);
  {
    ...
    add_svelte_meta(
      () => if_block(node, ($$render) => {
        ...
        else if (strict_equals(tag(), "button")) $$render(consequent_1, 1);
        else $$render(alternate, false);
      }),
      "if",
      ListGroupItem,
...
var root_49 = add_locations(from_html(`<button type="button" class="btn-close"></button>`), ModalHeader[FILENAME], [[44, 6]]);
...
function Modal($$anchor, $$props) {
  ...
  legacy_pre_effect(
    () => (deep_read_state(container()), deep_read_state(staticModal()), InlineContainer, Portal),
    () => {
      set(outer, strict_equals(container(), "inline") || staticModal() ? InlineContainer : Portal);
    }
  );
  legacy_pre_effect_reset();
  var $$exports = { ...legacy_api() };
  ...
  var node_8 = sibling(node, 2);
  {
    var consequent_4 = ($$anchor2) => {
      ...
      add_svelte_meta(
        () => component(node_9, () => get(outer), ($$anchor3, $$component) => {
          $$component($$anchor3, {
            children: wrap_snippet(Modal, ($$anchor4, $$slotProps) => {
              add_svelte_meta(
                () => ModalBackdrop($$anchor4, {
                  get fade() {
                    return fade2();
                  },
                  get isOpen() {
...
function Navbar($$anchor, $$props) {
  ...
  var node = child(nav);
  {
    var consequent = ($$anchor2) => {
      add_svelte_meta(
        () => Container($$anchor2, spread_props(() => containerProps, {
...
var root_410 = add_locations(from_html(`<button class="btn-close" type="button"></button>`), OffcanvasHeader[FILENAME], [[23, 6]]);
...
function Offcanvas($$anchor, $$props) {
  ...
  legacy_pre_effect(() => (deep_read_state(container()), InlineContainer, Portal), () => {
    set(outer, strict_equals(container(), "inline") ? InlineContainer : Portal);
  });
  legacy_pre_effect_reset();
  var $$exports = { ...legacy_api() };
  init();
...
var root_215 = add_locations(from_html(`<div><div class="popover-arrow" data-popper-arrow=""></div> <h3 class="popover-header"><!></h3> <div class="popover-body"><!></div></div>`), Popover[FILENAME], [[200, 4, [[208, 6], [209, 6], [212, 6]]]]);
...
var root_310 = add_locations(from_html(`<div><!></div>`), Progress[FILENAME], [[82, 4]]);
var root_63 = add_locations(from_html(`<div role="progressbar" aria-valuemin="0"><!></div>`), Progress[FILENAME], [[100, 6]]);
var root_411 = add_locations(from_html(`<div><!></div>`), Progress[FILENAME], [[96, 2]]);
function Progress($$anchor, $$props) {
  ...
  legacy_pre_effect(() => (deep_read_state(value()), deep_read_state(max2())), () => {
...
var root_216 = add_locations(from_html(`<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.2/font/bootstrap-icons.min.css"/>`), Styles[FILENAME], [[18, 4]]);
...
var root_54 = add_locations(from_html(`<tr><!></tr>`), Table[FILENAME], [[80, 10]]);
var root_217 = add_locations(from_html(`<!> <!> <tbody></tbody> <!>`, 1), Table[FILENAME], [[78, 6]]);
...
function TabHeader($$anchor, $$props) {
  ...
  init();
  add_svelte_meta(
    () => Nav($$anchor, spread_props(() => $$restProps, {
...
var root_311 = add_locations(from_html(`<!> <!>`, 1), TabPane[FILENAME], []);
var root_55 = add_locations(from_html(`<div><!></div>`), TabPane[FILENAME], [[37, 2]]);
...
var root_218 = add_locations(from_html(`<div><div class="tooltip-arrow" data-popper-arrow=""></div> <div class="tooltip-inner"><!></div></div>`), Tooltip[FILENAME], [[218, 4, [[228, 6], [229, 6]]]]);
  ...
  legacy_pre_effect(
    ...
    () => {
      if (isOpen() && get(tooltipEl)) {
        set(popperInstance, createPopper3(get(targetEl), get(tooltipEl), { placement: placement(), modifiers: [checkPopperPlacement] }));
      } else if (get(popperInstance)) {
        get(popperInstance).destroy();
        set(popperInstance, void 0);
      }
