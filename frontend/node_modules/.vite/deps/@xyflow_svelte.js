import "./chunk-TRRXUOIS.js";
import "./chunk-4JCCGCAW.js";
import {
  MediaQuery
} from "./chunk-5TDSUY3U.js";
import {
  CLASS,
  STYLE,
  action,
...
import {
  ...
  user_effect,
  user_pre_effect
} from "./chunk-NYO7I2WC.js";
import "./chunk-EDNMQROW.js";
...
var root2 = add_locations(from_html(`<div><!></div>`), Handle[FILENAME], [[151, 0]]);
function Handle($$anchor, $$props) {
  ...
  var node = child(div);
  add_svelte_meta(() => snippet(node, () => $$props.children ?? noop), "render", Handle, 185, 2);
  reset(div);
  append($$anchor, div);
  return pop($$exports);
}
...
var root6 = add_locations(from_html(`<div><!></div>`), EdgeLabel[FILENAME], [[23, 0]]);
var $$css = {
  hash: "svelte-1wg91mu",
  code: "\r\n  .transparent.svelte-1wg91mu {\r\n    background: transparent;\r\n  }\r\n\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"
};
function EdgeLabel($$anchor, $$props) {
  ...
  var node = child(div);
  add_svelte_meta(() => snippet(node, () => $$props.children ?? noop), "render", EdgeLabel, 39, 2);
  reset(div);
...
var root7 = add_locations(from_svg(`<path fill="none"></path><!><!>`, 1), BaseEdge[FILENAME], [[18, 0]]);
...
function getInitialStore(signals) {
  ...
  class SvelteFlowStore {
    constructor() {
      ...
      __privateAdd(this, _zIndexMode, state(signals.props.zIndexMode ?? "basic"));
      ...
      __privateAdd(this, _autoPanSpeed, user_derived(() => signals.props.autoPanSpeed ?? 15));
...
var root8 = add_locations(from_html(`<div class="svelte-flow__zoom svelte-flow__container"><!></div>`), Zoom[FILENAME], [[33, 0]]);
function Zoom($$anchor, $$props) {
  ...
  var div = root8();
  var node = child(div);
  add_svelte_meta(() => snippet(node, () => $$props.children), "render", Zoom, 71, 2);
  reset(div);
  action(div, ($$node, $$action_arg) => {
    var _a;
    ...
    onDraggingChange: (dragging) => {
      $$ownership_validator.mutation("store", ["store", "dragging"], store(store().dragging = dragging, true), 41, 6);
    },
    setPanZoomInstance: (instance) => {
      $$ownership_validator.mutation("store", ["store", "panZoom"], store(store().panZoom = instance, true), 44, 6);
    },
    ...
    onTransformChange: (transform2) => {
      $$ownership_validator.mutation("store", ["store", "viewport"], store(store().viewport = { x: transform2[0], y: transform2[1], zoom: transform2[2] }, true), 66, 6);
    },
...
var root9 = add_locations(from_html(`<div><!></div>`), Pane[FILENAME], [[178, 0]]);
function Pane($$anchor, $$props) {
  ...
  function onPointerDownCapture(event2) {
    ...
    $$ownership_validator.mutation("store", ["store", "selectionRect"], store(store().selectionRect = { width: 0, height: 0, startX: x, startY: y, x, y }, true), 67, 2);
  ...
  function onPointerMove(event2) {
    ...
    if (!isSetEqual(prevSelectedNodeIds, selectedNodeIds)) {
      $$ownership_validator.mutation("store", ["store", "nodes"], store(store().nodes = store().nodes.map(toggleSelected(selectedNodeIds)), true), 127, 4);
    }
    if (!isSetEqual(prevSelectedEdgeIds, selectedEdgeIds)) {
      $$ownership_validator.mutation("store", ["store", "edges"], store(store().edges = store().edges.map(toggleSelected(selectedEdgeIds)), true), 130, 4);
    }
    $$ownership_validator.mutation("store", ["store", "selectionRectMode"], store(store().selectionRectMode = "user", true), 132, 2);
    $$ownership_validator.mutation("store", ["store", "selectionRect"], store(store().selectionRect = nextUserSelectRect, true), 133, 2);
  }
  function onPointerUp(event2) {
    ...
    $$ownership_validator.mutation("store", ["store", "selectionRect"], store(store().selectionRect = null, true), 143, 2);
    if (selectionInProgress) {
      $$ownership_validator.mutation("store", ["store", "selectionRectMode"], store(store().selectionRectMode = selectedNodeIds.size > 0 ? "nodes" : null, true), 145, 4);
    }
    if (selectionInProgress) {
  ...
  function onClick(event2) {
    ...
    store().unselectNodesAndEdges();
    $$ownership_validator.mutation("store", ["store", "selectionRectMode"], store(store().selectionRectMode = null, true), 171, 2);
    $$ownership_validator.mutation("store", ["store", "selectionRect"], store(store().selectionRect = null, true), 172, 2);
  }
  var $$exports = { ...legacy_api() };
  var div = root9();
  let classes;
  ...
  div.__click = function(...$$args) {
    apply(() => get(event_handler), this, $$args, Pane, [184, 11]);
  };
  div.__pointermove = function(...$$args) {
    apply(() => get(isSelectionEnabled) ? onPointerMove : void 0, this, $$args, Pane, [186, 17]);
  };
  div.__pointerup = function(...$$args) {
    apply(() => get(isSelectionEnabled) ? onPointerUp : void 0, this, $$args, Pane, [187, 15]);
  };
  var event_handler_1 = user_derived(() => wrapHandler(onContextMenu, container));
  div.__contextmenu = function(...$$args) {
    apply(() => get(event_handler_1), this, $$args, Pane, [188, 17], true);
  };
  var node = child(div);
  add_svelte_meta(() => snippet(node, () => $$props.children), "render", Pane, 191, 2);
  reset(div);
  ...
  event(
    ...
    div,
    function(...$$args) {
      apply(() => get(isSelectionEnabled) ? onPointerDownCapture : void 0, this, $$args, Pane, [185, 24]);
    },
    true
  );
  event(
    ...
    div,
    function(...$$args) {
      apply(() => get(isSelectionEnabled) ? onClickCapture : void 0, this, $$args, Pane, [189, 18]);
    },
    true
  );
  append($$anchor, div);
...
var root10 = add_locations(from_html(`<div class="svelte-flow__viewport xyflow__viewport svelte-flow__container"><!></div>`), Viewport[FILENAME], [[7, 0]]);
function Viewport($$anchor, $$props) {
  ...
  let styles;
  var node = child(div);
  add_svelte_meta(() => snippet(node, () => $$props.children), "render", Viewport, 12, 2);
  reset(div);
...
var root_13 = add_locations(from_html(`<div><!></div>`), NodeWrapper[FILENAME], [[180, 2]]);
...
var root12 = add_locations(from_html(`<div class="svelte-flow__nodes"></div>`), NodeRenderer[FILENAME], [[32, 0]]);
...
function EdgeWrapper($$anchor, $$props) {
  ...
  function onclick(event2) {
    var _a;
    const edge2 = $$props.store.edgeLookup.get(get(id2));
    if (edge2) {
...
var root13 = add_locations(from_svg(`<defs></defs>`), MarkerDefinition[FILENAME], [[6, 0]]);
function MarkerDefinition($$anchor, $$props) {
  ...
  add_svelte_meta(
    () => each(defs, 5, () => store.markers, (marker) => marker.id, ($$anchor2, marker) => {
      add_svelte_meta(() => Marker($$anchor2, spread_props(() => get(marker))), "component", MarkerDefinition, 8, 4, { componentTag: "Marker" });
    }),
    "each",
    MarkerDefinition,
    7,
...
var root_15 = add_locations(from_svg(`<polyline class="arrow" fill="none" stroke-linecap="round" stroke-linejoin="round" points="-5,-4 0,0 -5,4"></polyline>`), Marker[FILENAME], [[26, 4]]);
var root_2 = add_locations(from_svg(`<polyline class="arrowclosed" stroke-linecap="round" stroke-linejoin="round" points="-5,-4 0,0 -5,4 -5,-4"></polyline>`), Marker[FILENAME], [[36, 4]]);
var root14 = add_locations(from_svg(`<marker class="svelte-flow__arrowhead" viewBox="-10 -10 20 20" refX="0" refY="0"><!></marker>`), Marker[FILENAME], [[14, 0]]);
...
var root15 = add_locations(from_html(`<div class="svelte-flow__edges"><svg class="svelte-flow__marker"><!></svg> <!></div>`), EdgeRenderer[FILENAME], [[12, 0, [[13, 2]]]]);
function EdgeRenderer($$anchor, $$props) {
  ...
  var svg = child(div);
  var node = child(svg);
  add_svelte_meta(() => MarkerDefinition(node, {}), "component", EdgeRenderer, 14, 4, { componentTag: "MarkerDefinition" });
  reset(svg);
...
var root_16 = add_locations(from_html(`<div class="svelte-flow__selection svelte-1vr3gfi"></div>`), Selection3[FILENAME], [[12, 2]]);
var $$css3 = {
  hash: "svelte-1vr3gfi",
  code: "\r\n  .svelte-flow__selection.svelte-1vr3gfi {\r\n    position: absolute;\r\n    top: 0;\r\n    left: 0;\r\n  }\r\n\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"
};
...
var root_17 = add_locations(from_html(`<div><!></div>`), NodeSelection[FILENAME], [[50, 2]]);
var $$css4 = {
  hash: "svelte-sf2y5e",
  code: "\r\n  .svelte-flow__selection-wrapper.svelte-sf2y5e {\r\n    position: absolute;\r\n    top: 0;\r\n    left: 0;\r\n    z-index: 2000;\r\n    pointer-events: all;\r\n  }\r\n\r\n  .svelte-flow__selection-wrapper.svelte-sf2y5e:focus,\r\n  .svelte-flow__selection-wrapper.svelte-sf2y5e:focus-visible {\r\n    outline: none;\r\n  }\r\n\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"
};
  ...
  var node_1 = first_child(fragment);
  {
    var consequent = ($$anchor2) => {
      ...
      div.__keydown = function(...$$args) {
        apply(() => $$props.store.disableKeyboardA11y ? void 0 : onkeydown, this, $$args, NodeSelection, [72, 15]);
      };
      let styles;
      var node_2 = child(div);
      add_svelte_meta(() => Selection3(node_2, { width: "100%", height: "100%", x: 0, y: 0 }), "component", NodeSelection, 75, 4, { componentTag: "Selection" });
      reset(div);
      action(div, ($$node, $$action_arg) => {
        var _a;
        return (_a = drag) == null ? void 0 : _a($$node, $$action_arg);
...
function KeyHandler($$anchor, $$props) {
  ...
  action($window, ($$node, $$action_arg) => {
    ...
    trigger: getShortcutTrigger(selectionKey(), () => $$ownership_validator.mutation("store", ["store", "selectionKeyPressed"], store(store().selectionKeyPressed = true, true), 61, 53)),
    type: "keydown"
  }));
  action($window, ($$node, $$action_arg) => {
    var _a;
    ...
    trigger: getShortcutTrigger(selectionKey(), () => $$ownership_validator.mutation("store", ["store", "selectionKeyPressed"], store(store().selectionKeyPressed = false, true), 65, 53)),
    type: "keyup"
  }));
  action($window, ($$node, $$action_arg) => {
    var _a;
    ...
    trigger: getShortcutTrigger(multiSelectionKey(), () => {
      $$ownership_validator.mutation("store", ["store", "multiselectionKeyPressed"], store(store().multiselectionKeyPressed = true, true), 70, 6);
    }),
    type: "keydown"
  }));
  action($window, ($$node, $$action_arg) => {
    ...
    trigger: getShortcutTrigger(multiSelectionKey(), () => $$ownership_validator.mutation("store", ["store", "multiselectionKeyPressed"], store(store().multiselectionKeyPressed = false, true), 75, 58)),
    type: "keyup"
  }));
  action($window, ($$node, $$action_arg) => {
    var _a;
    ...
    trigger: getShortcutTrigger(deleteKey(), (detail) => {
      ...
      if (!isModifierKey && !isInputDOMNode(detail.originalEvent)) {
        $$ownership_validator.mutation("store", ["store", "deleteKeyPressed"], store(store().deleteKeyPressed = true, true), 85, 8);
        handleDelete();
      }
    }),
    type: "keydown"
  ...
  action($window, ($$node, $$action_arg) => {
    ...
    trigger: getShortcutTrigger(deleteKey(), () => $$ownership_validator.mutation("store", ["store", "deleteKeyPressed"], store(store().deleteKeyPressed = false, true), 92, 50)),
    type: "keyup"
  }));
  action($window, ($$node, $$action_arg) => {
    var _a;
    ...
    trigger: getShortcutTrigger(panActivationKey(), () => $$ownership_validator.mutation("store", ["store", "panActivationKeyPressed"], store(store().panActivationKeyPressed = true, true), 96, 57)),
    type: "keydown"
  }));
  action($window, ($$node, $$action_arg) => {
    var _a;
    ...
    trigger: getShortcutTrigger(panActivationKey(), () => $$ownership_validator.mutation("store", ["store", "panActivationKeyPressed"], store(store().panActivationKeyPressed = false, true), 100, 57)),
    type: "keyup"
  }));
  action($window, ($$node, $$action_arg) => {
    var _a;
    ...
    trigger: getShortcutTrigger(zoomActivationKey(), () => $$ownership_validator.mutation("store", ["store", "zoomActivationKeyPressed"], store(store().zoomActivationKeyPressed = true, true), 104, 58)),
    type: "keydown"
  }));
  action($window, ($$node, $$action_arg) => {
    var _a;
    ...
    trigger: getShortcutTrigger(zoomActivationKey(), () => $$ownership_validator.mutation("store", ["store", "zoomActivationKeyPressed"], store(store().zoomActivationKeyPressed = false, true), 108, 58)),
    type: "keyup"
  }));
  return pop($$exports);
}
...
var root_3 = add_locations(from_svg(`<path fill="none" class="svelte-flow__connection-path"></path>`), ConnectionLine[FILENAME], [[59, 8]]);
...
var root16 = add_locations(from_html(`<div><!></div>`), Panel[FILENAME], [[5, 0]]);
function Panel($$anchor, $$props) {
  ...
  var node = child(div);
  add_svelte_meta(() => snippet(node, () => $$props.children ?? noop), "render", Panel, 6, 2);
  reset(div);
  append($$anchor, div);
  return pop($$exports);
}
...
var root_22 = add_locations(from_html(`<a href="https://svelteflow.dev" target="_blank" rel="noopener noreferrer" aria-label="Svelte Flow attribution">Svelte Flow</a>`), Attribution[FILENAME], [[11, 4]]);
...
var root17 = add_locations(from_html(`<div><!></div>`), Wrapper[FILENAME], [[91, 0]]);
var $$css5 = {
  hash: "svelte-mkap6j",
  code: "\r\n  .svelte-flow.svelte-mkap6j {\r\n    width: 100%;\r\n    height: 100%;\r\n    overflow: hidden;\r\n    position: relative;\r\n    z-index: 0;\r\n\r\n    background-color: var(--background-color, var(--background-color-default));\r\n  }\r\n\r\n  :root {\r\n    --background-color-default: #fff;\r\n    --background-pattern-color-default: #ddd;\r\n\r\n    --minimap-mask-color-default: rgb(240, 240, 240, 0.6);\r\n    --minimap-mask-stroke-color-default: none;\r\n    --minimap-mask-stroke-width-default: 1;\r\n\r\n    --controls-button-background-color-default: #fefefe;\r\n    --controls-button-background-color-hover-default: #f4f4f4;\r\n    --controls-button-color-default: inherit;\r\n    --controls-button-color-hover-default: inherit;\r\n    --controls-button-border-color-default: #eee;\r\n  }\r\n\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"
};
function Wrapper($$anchor, $$props) {
  ...
  var node = child(div);
  add_svelte_meta(() => snippet(node, () => $$props.children ?? noop), "render", Wrapper, 103, 2);
  reset(div);
...
var root_4 = add_locations(from_html(`<div class="svelte-flow__viewport-back svelte-flow__container"></div> <!> <div class="svelte-flow__edge-labels svelte-flow__container"></div> <!> <!> <!> <div class="svelte-flow__viewport-front svelte-flow__container"></div>`, 1), SvelteFlow[FILENAME], [[160, 8], [168, 8], [196, 8]]);
...
function SvelteFlow($$anchor, $$props) {
  ...
  var $$exports = { ...legacy_api() };
  validate_binding("bind:domNode={store.domNode}", [], () => store, () => "domNode", 116, 2);
  validate_binding("bind:clientWidth={store.width}", [], () => store, () => "width", 117, 2);
  validate_binding("bind:clientHeight={store.height}", [], () => store, () => "height", 118, 2);
  add_svelte_meta(
    () => Wrapper($$anchor, {
      get colorMode() {
      ...
      children: wrap_snippet(SvelteFlow, ($$anchor2, $$slotProps) => {
        ...
        add_svelte_meta(() => snippet(node_10, () => $$props.children ?? noop), "render", SvelteFlow, 209, 2);
...
function SvelteFlowProvider($$anchor, $$props) {
  ...
  var fragment = comment();
  var node = first_child(fragment);
  add_svelte_meta(() => snippet(node, () => $$props.children ?? noop), "render", SvelteFlowProvider, 25, 0);
  append($$anchor, fragment);
  return pop($$exports);
}
...
var root18 = add_locations(from_html(`<div><!></div>`), ViewportPortal[FILENAME], [[5, 0]]);
function ViewportPortal($$anchor, $$props) {
  ...
  var node = child(div);
  add_svelte_meta(() => snippet(node, () => $$props.children ?? noop), "render", ViewportPortal, 10, 2);
  reset(div);
  action(div, ($$node, $$action_arg) => {
    var _a;
    return (_a = portal) == null ? void 0 : _a($$node, $$action_arg);
          ...
          children: wrap_snippet(EdgeReconnectAnchor, ($$anchor2, $$slotProps) => {
            ...
            var node = first_child(fragment_1);
            {
              var consequent = ($$anchor3) => {
                ...
                add_svelte_meta(() => snippet(node_1, () => $$props.children), "render", EdgeReconnectAnchor, 108, 4);
...
var root19 = add_locations(from_html(`<button><!></button>`), ControlButton[FILENAME], [[14, 0]]);
function ControlButton($$anchor, $$props) {
  ...
  add_svelte_meta(() => snippet(node, () => $$props.children ?? noop), "render", ControlButton, 25, 2);
  reset(button);
          ...
          children: wrap_snippet(Controls, ($$anchor2, $$slotProps) => {
            ...
            var node = first_child(fragment_1);
            {
              var consequent = ($$anchor3) => {
                var fragment_2 = comment();
                var node_1 = first_child(fragment_2);
                add_svelte_meta(() => snippet(node_1, () => $$props.before), "render", Controls, 69, 4);
                append($$anchor3, fragment_2);
              };
              add_svelte_meta(
                () => if_block(node, ($$render) => {
              ...
              var consequent_1 = ($$anchor3) => {
                  ...
                  () => ControlButton(node_3, spread_props(
                    ...
                    () => buttonProps,
                    {
                      children: wrap_snippet(Controls, ($$anchor4, $$slotProps2) => {
                        add_svelte_meta(() => Plus($$anchor4, {}), "component", Controls, 80, 6, { componentTag: "PlusIcon" });
                      }),
                      $$slots: { default: true }
                    }
                  )),
                ...
                add_svelte_meta(
                  () => ControlButton(node_4, spread_props(
                    ...
                    {
                      children: wrap_snippet(Controls, ($$anchor4, $$slotProps2) => {
                        add_svelte_meta(() => Minus($$anchor4, {}), "component", Controls, 90, 6, { componentTag: "MinusIcon" });
                      }),
                      $$slots: { default: true }
                    }
                  )),
              ...
              var consequent_2 = ($$anchor3) => {
                add_svelte_meta(
                  () => ControlButton($$anchor3, spread_props(
                    ...
                    {
                      children: wrap_snippet(Controls, ($$anchor4, $$slotProps2) => {
                        add_svelte_meta(() => Fit($$anchor4, {}), "component", Controls, 101, 6, { componentTag: "FitViewIcon" });
                      }),
                      $$slots: { default: true }
                    }
                  )),
                      ...
                      children: wrap_snippet(Controls, ($$anchor4, $$slotProps2) => {
                        ...
                        var node_7 = first_child(fragment_9);
                        {
                          var consequent_3 = ($$anchor5) => {
                            add_svelte_meta(() => Unlock($$anchor5, {}), "component", Controls, 112, 25, { componentTag: "UnlockIcon" });
                          };
                          var alternate = ($$anchor5) => {
                            add_svelte_meta(() => Lock($$anchor5, {}), "component", Controls, 112, 46, { componentTag: "LockIcon" });
                          };
                          add_svelte_meta(
            ...
            var node_8 = sibling(node_6, 2);
            {
              var consequent_5 = ($$anchor3) => {
                ...
                add_svelte_meta(() => snippet(node_9, () => $$props.children), "render", Controls, 116, 4);
            ...
            var node_10 = sibling(node_8, 2);
            {
              var consequent_6 = ($$anchor3) => {
                ...
                add_svelte_meta(() => snippet(node_11, () => $$props.after), "render", Controls, 119, 4);
...
var root25 = add_locations(from_svg(`<circle></circle>`), DotPattern[FILENAME], [[4, 0]]);
...
var root26 = add_locations(from_svg(`<path></path>`), LinePattern[FILENAME], [[9, 0]]);
...
var root27 = add_locations(from_svg(`<svg data-testid="svelte-flow__background"><pattern patternUnits="userSpaceOnUse"><!></pattern><rect x="0" y="0" width="100%" height="100%"></rect></svg>`), Background[FILENAME], [[41, 0, [[47, 2], [62, 2]]]]);
...
var root_23 = add_locations(from_svg(`<rect></rect>`), MinimapNode[FILENAME], [[36, 2]]);
...
var root_34 = add_locations(from_svg(`<title> </title>`), Minimap[FILENAME], [[102, 8]]);
var root_24 = add_locations(from_svg(`<svg class="svelte-flow__minimap-svg" role="img"><!><!><path class="svelte-flow__minimap-mask" fill-rule="evenodd" pointer-events="none"></path></svg>`), Minimap[FILENAME], [[76, 4, [[125, 6]]]]);
var root28 = add_locations(from_html(`<svelte-css-wrapper style="display: contents"><!></svelte-css-wrapper>`, 1), Minimap[FILENAME], [[68, 0]]);
...
var root_111 = add_locations(from_html(`<div><!></div>`), NodeToolbar[FILENAME], [[49, 2]]);
function NodeToolbar($$anchor, $$props) {
  ...
  var node_1 = first_child(fragment);
  {
    var consequent = ($$anchor2) => {
      ...
      var node_2 = child(div);
      add_svelte_meta(() => snippet(node_2, () => $$props.children ?? noop), "render", NodeToolbar, 59, 4);
      reset(div);
      action(div, ($$node, $$action_arg) => {
        var _a;
        return (_a = portal) == null ? void 0 : _a($$node, $$action_arg);
...
var root_25 = add_locations(from_html(`<div><!></div>`), EdgeToolbar[FILENAME], [[26, 4]]);
      ...
      add_svelte_meta(
        () => EdgeLabel($$anchor2, {
          ...
          children: wrap_snippet(EdgeToolbar, ($$anchor3, $$slotProps) => {
            ...
            add_svelte_meta(() => snippet(node_1, () => $$props.children ?? noop), "render", EdgeToolbar, 34, 6);
            reset(div);
            append($$anchor3, div);
          }),
          $$slots: { default: true }
...
var root29 = add_locations(from_html(`<div><!></div>`), ResizeControl[FILENAME], [[106, 0]]);
function ResizeControl($$anchor, $$props) {
  ...
  var node_1 = child(div);
  add_svelte_meta(() => snippet(node_1, () => $$props.children ?? noop), "render", ResizeControl, 114, 2);
  reset(div);
