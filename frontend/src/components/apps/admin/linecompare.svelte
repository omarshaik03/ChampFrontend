...
>
    <div style="background-color: {backgroundColor};">
        ...
        {#each myChangeLineArray as myChangeLine}
            <Row>  
                <div class="col w-50" style="background-color: {color.oldText[myChangeLine.changeType]}">
                ...
                <div class="col w-50" style="background-color: {color.newText[myChangeLine.changeType]}">
